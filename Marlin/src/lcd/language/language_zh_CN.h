...
namespace Language_zh_CN {
  ...
  PROGMEM Language_Str MSG_LANGUAGE                        = _UxGT("语言");
  PROGMEM Language_Str MSG_ENGLISH_LANGUAGE                = _UxGT("English");
  PROGMEM Language_Str MSG_CHINESE_LANGUAGE                = _UxGT("简体中文");
  ...
  PROGMEM Language_Str MSG_MARLIN_WEBSITE_URL              = _UxGT("www.cxsw3d.com");
