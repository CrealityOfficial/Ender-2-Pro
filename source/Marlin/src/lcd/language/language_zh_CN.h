...
namespace Language_zh_CN {
  ...
  PROGMEM Language_Str LANGUAGE                            = _UxGT("Chinese");
  ...
  PROGMEM Language_Str MSG_SD_INIT_FAIL                    = _UxGT("存储卡启动失败");
  ...
  PROGMEM Language_Str MSG_EXTRUDERS_HEATING               = _UxGT("喷头加热中...");
  PROGMEM Language_Str MSG_EXTRUDERS_COOLING               = _UxGT("喷头冷却中...");
