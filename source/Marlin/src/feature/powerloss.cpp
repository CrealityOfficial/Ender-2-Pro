...
void PrintJobRecovery::save(const bool force/*=false*/, const float zraise/*=0*/) {
  ...
  if (force
      ...
      || current_position.z > info.current_position.z + 0.05f
    #endif
  ) {
...
void PrintJobRecovery::resume() {
  ...
  gcode.process_subcommands_now_P(PSTR("M17 Z"));
  #if HAS_LEVELING
...
//=============================================================modified by kim
  ...
  // Reset E, raise Z, home XY...
    ...
    gcode.process_subcommands_now(cmd);
		...
		float z_print = POWER_LOSS_ZRAISE;
//					z_print = info.current_position.z + POWER_LOSS_ZRAISE;
 ...
 // }
  ...
  #endif
  //========================================================================================== modified by kim
  set_all_homed();                //mark all axis homed no effect on current position;
...
//  gcode.process_subcommands_now_P(PSTR("G29.9E0"));
