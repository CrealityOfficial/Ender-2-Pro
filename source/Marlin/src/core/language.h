...
#include LANGUAGE_INCL(LCD_LANGUAGE_6)
#include LANGUAGE_INCL(LCD_LANGUAGE_7)
#include LANGUAGE_INCL(LCD_LANGUAGE_8)
#include LANGUAGE_INCL(LCD_LANGUAGE_9)
#include LANGUAGE_INCL(LCD_LANGUAGE_10)
