...
#define AUTOTEMP
#if ENABLED(AUTOTEMP)
  #define AUTOTEMP_OLDWEIGHT    0.98f
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_5X_STEPS_PER_SEC    10
...
//
  ...
  #define LCD_LANGUAGE_5  tr
  #define LCD_LANGUAGE_6  it
  #define LCD_LANGUAGE_7  de
  #define LCD_LANGUAGE_8  ru
  #define LCD_LANGUAGE_9  fr
